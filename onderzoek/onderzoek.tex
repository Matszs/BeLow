...
\section{Discussion}
%==============================================================================
An important next step in the process is to work towards the wisdom layer. This can be done by acquiring a data pool which is large enough to allow for thorough analysis by experts. Adding context to the data and relating certain factors to telltale signs of calamity. For example: if a door has not been opened all day, this may indicate that there is something wrong with the user. However, other sensor readings may indicate that the owner has not passed through the door for different reasons; maybe they weren't home. It is important to rely on a combination of factors rather than each reading individually. It will take the trained eye of a professional to determine whether certain readings indicate that there is something wrong. Machine learning will prove itself invaluable in this process, as indicators may vary from one user to another. Trends, and deviations from these trends, will be very important when determining what conclusions can be drawn from the information supplied. Experts may determine that a substantial increase in in-home wandering could be a symptom of dementia, it is important to note that 'in-home activity' is not a value set in stone. This varies per user, and therefore it is important to know what measure of activity is normal per individual user, and what is a deviation. Also, neural networks may be used to discover correlations between readings from different sensors and what conclusion should be drawn from this.   
