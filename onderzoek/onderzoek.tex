...
\section{Discussion}
%==============================================================================
An important next step once the data has been gathered, is creating a layer of wisdom. This is done through prolonged periods of data acquisition, and adding context to them based on patterns uncovered by means of machine learning and thorough analysis so that the data may be well understood, and predictions may be done based off this understanding. With the added knowledge, response time in case of calamity can be reduced drastically, for example in case of a fall, inability to leave a certain area of the home, change in temperature or gas leak, all of which can potentially lead to serious injury. When the data pool becomes large enough, research add yet another layer, the layer of wisdom, to the whole. By combining the right sensor readings and behavioral patterns, it may in the future become possible well before calamity even occurs; for example in the case of conditions such as bone atrophy, which cause fall incidents. By recognizing early symptoms, an incident may be prevented rather than merely responded to.

Before all this, however, to enlarge the data pool as much as possible more efforts should be put into designing systems in such a way that they can be blended into the living space, and customized according to the user's wishes. The systems should grow alongside their target audience, not separate of them.  Furthermore, respondents stressed the importance of feedback. This is what really creates interaction with the environment because it may not only be used to keep the user up to date, but also stimulates the user to perform certain actions and maintain daily rituals that are beneficial for their health and wellbeing, as well as eventually recognizing early symptoms of otherwise serious conditions.
%==============================================================================
\section{Conclusion}
%==============================================================================
